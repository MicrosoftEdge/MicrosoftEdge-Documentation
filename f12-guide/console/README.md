...
Console selectors provide simple shorthands for quickly selecting elements in your DOM structure. They are:
   ...
   - **$0, $1, $2, $3, $4** return the last items selected in the [**DOM Explorer tool**](../DOMExplorer/).
...
##Related topics
[Using the Console API](/UsingtheConsoleAPI/)
